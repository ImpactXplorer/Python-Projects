...
class FrontEnd:
    ...
    def menu_initialisation(self):
        ...
        self.logo = PhotoImage(file='C:/Users/User/OneDrive/Desktop/editor/cosmos.gif').subsample(3, 3)
        print(self.logo)
        ttk.Label(self.frame_header, image=self.logo).grid(
            row=0, column=0, rowspan=2)
        ttk.Label(self.frame_header, text='Welcome to my World').grid(
            row=0, column=1, columnspan=1)
        ttk.Label(self.frame_header, text='Everything that you want to edit').grid(
